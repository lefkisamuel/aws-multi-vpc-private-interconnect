...
class VPCNestedStack(NestedStack):
    ...
    private_subnets_with_egress_by_vpc_name:dict[str:bool] = {}
    def __init__(self, scope: Construct, id: str, vpcs: dict, **kwargs) -> None:
        ...
        for vpc_name, vpc_details in vpcs.items():
            ...
            self.private_subnets_with_egress_by_vpc_name[vpc_name] = private_subnets_with_egress
        ...
        #Loop through the vpcs and create a security group for each vpc that allows all traffic from each other
